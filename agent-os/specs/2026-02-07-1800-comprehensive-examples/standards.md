...
This spec applies three standards from `agent-os/standards/`:

## 1. Agent Verification Standard

**File:** `agent-os/standards/agent-verification.md`
...
**File:** `agent-os/standards/testing/function-based-tests.md`
...
**File:** `agent-os/standards/testing/sybil-doctest.md`
