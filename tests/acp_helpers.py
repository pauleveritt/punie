"""ACP test helpers: fake implementations for testing.

Ported from python-acp-sdk tests/conftest.py with naming changes:
- TestAgent → FakeAgent
- TestClient → FakeClient

These fakes provide in-memory implementations of ACP protocols for testing.
"""
